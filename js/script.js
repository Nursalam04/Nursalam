...
$.getJSON("assets\Bentik\Batasadministrasi.geojson", function (OBJECTID) { 
L.geoJSON(OBJECTID, { 
style: { 
color : "black", 
weight : 2, 
...
lineJoin: 'round',
fillOpacity: 0 // Tambahkan ini jika ingin area tidak diisi warna
}
...
$.getJSON("assets/Bentik/Bentik.geojson", function (OBJECTID) { 
L.geoJson(OBJECTID, { 
...
const Component = {
  ...
  "BatasAdministrasiKecamatan": BatasAdministrasi,
  "Bentik": Bentik
};
