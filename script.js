...
$.getJSON("./assets\Bentik\Pelabuhan Labuhan Bajo.geojson", function (OBJECTID) { 
    L.geoJSON(OBJECTID, { 
...
$.getJSON("./assets\Bentik\Batas Administrasi.geojson", function (OBJECTID) { 
L.geoJSON(OBJECTID, { 
style: { 
color : "black", 
weight : 2, 
...
$.getJSON("./assets\Bentik\Bentik.geojson", function (REMARK) { 
L.geoJson(REMARK, { 
...
layer.bindPopup('<b>Bentik: </b>'+ feature.properties.REMARK) 
} 
}).addTo(Bentik); 
}); 
Bentik.addTo(map); 
...
const Component = {
  "Pelabuhan Labuhan Bajo": Pelabuhan,
  "Batas Administrasi Kecamatan": BatasAdministrasi,
  "Bentik": Bentik
};
